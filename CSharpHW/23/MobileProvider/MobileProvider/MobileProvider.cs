...
namespace MobileProvider
{
    class Provider : IMobileProvider
    {
        ...
        {
            return Accounts.Any(p => p.Name == account.Name && p.Surname == account.Surname && p.Email == account.Email);
        }
        ...
        public void AddAccount(IMobileAccount account)
        {
            ...
            {
                account.Number = account.Number == 0 ? GeneratePhoneNumber() : account.Number;
